...
export const RECIPES: Recipe[] = [
  ...
  },
  {
    ...
    ingredients: ["כוס מיץ תפוזים סחוט", "קובייה SimpliiGood מופשרת"],
  ...
  },
  {
    ...
    ingredients: ["קופסת טונה", "קובייה SimpliiGood מופשרת (במקום מיונז)", "מלח ופלפל לפי הטעם"],
  ...
  },
  {
    ...
    ingredients: ["אבוקדו בשל (או הגוואקמולה האהובה עליכם)", "קובייה SimpliiGood מופשרת", "לימון, מלח, פלפל"],
  ...
  // ===== רמה 2 — דקה =====
  {
    ...
    ingredients: ["2 קוביות SimpliiGood טרייה", "בננה קפואה או טרייה", "חופן בייבי תרד טרי", "2 כפות זרעי פשתן (מעל)", "כף אבקת חלבון (לא חובה)", "3/4 כוס חלב שקדים או נוזל אחר"],
  ...
  },
  {
    ...
    ingredients: ["2 קוביות SimpliiGood טרייה", "בננה קפואה", "6–8 תותים קפואים", "כף גדושה חמאת בוטנים או אבקת חלבון", "1/2 כוס חלב או חלב צמחי", "לקישוט: פירות טריים"],
  ...
  // ===== רמה 3 — 5 דקות =====
  {
    ...
    ingredients: ["2 קוביות SimpliiGood טרייה", "1/2 כוס טחינה גולמית", "2 שיני שום קלופות", "צרור פטרוזיליה או כוסברה", "מיץ מלימון", "1/4 כפית מלח ופלפל שחור", "כוס מים"],
  ...
  },
  {
    ...
    level: 3, timeLabel: "5 דק'", cubes: 2, meal: "צהריים",
    ingredients: ["2 קוביות SimpliiGood טרייה", "מיץ מחצי תפוז", "מיץ מחצי לימון", "2 כפות דבש או סירופ מייפל", "כפית חרדל", "3 כפות שמן זית", "מלח ופלפל לפי הטעם"],
  ...
  },
  {
    ...
    ingredients: ["חופן בזיליקום", "2 קוביות SimpliiGood טרייה", "3 כפות שמן זית", "כף צנוברים או אגוזי מלך", "שן שום", "פרמזן (אופציונלי)"],
  ...
  // ===== רמה 4 — שווה את ההשקעה =====
  {
    ...
    ingredients: ["2 קוביות SimpliiGood טרייה", "בננה וחצי מעוכה", "2 כפות זרעי צ'יה", "כף חמאת שקדים או פיסטוק", "1/4 כוס קרם קוקוס", "1/2 כוס חלב שקדים או צמחי לבחירתכם", "לקישוט: יוגורט, פיסטוקים קצוצים, פירות אהובים"],
  ...
  },
  {
    ...
    ingredients: ["2 קוביות SimpliiGood טרייה", "2 כוסות יוגורט לבחירתכם (גם ללא חלב עובד)", "תוספות כיד הדמיון: שוקולד לבן מומס, אוכמניות, קוקוס טחון, פיסטוקים כתושים"],
...
export const FAQS: { q: string; a: string }[] = [
  { q: "כמה קוביות ביום?", a: "מתחילים ב-2 קוביות (28 גרם) ביום למשך 30 יום. אחרי שהגוף מתרגל, אפשר לשקול להגדיל ל-3 קוביות (42 גרם) ביום." },
