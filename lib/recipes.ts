...
export const RECIPES: Recipe[] = [
  ...
  {
    slug: "green-bali-shake",
    name: "שייק גרין באלי",
    level: 2, timeLabel: "דקה", cubes: 2, meal: "בוקר",
    ingredients: ["בננה קפואה", "1/2 כוס קוביות אננס", "תמר מגולען", "כ-1 ס\"מ ג'ינג'ר טרי", "2 מנות SimpliiGood (28 גר')", "כוס חלב שקדים או רגיל", "קוביות קרח (אופציונלי)"],
  ...
  },
  {
    ...
    name: "גרין גארדן בול",
    level: 2, timeLabel: "דקה", cubes: 2, meal: "בוקר",
    ingredients: ["בננה קפואה", "תמר מג'הול מגולען", "כוס עלי תרד טריים דחוסים", "2 מנות SimpliiGood (28 גר')", "3/4 כוס חלב שקדים (~180 מ\"ל)", "קרח (אופציונלי)", "לקישוט: פירות, גרנולה, צ'יה, אגוזים"],
  ...
  },
  {
    ...
    name: "שייק גרין דיי",
    level: 2, timeLabel: "דקה", cubes: 2, meal: "ביניים",
    ingredients: ["בננה קפואה", "כוס עלי תרד טריים", "1/2 תפוח ירוק חתוך לקוביות", "4–5 עלי נענע טריים", "כפית זרעי צ'יה", "2 מנות SimpliiGood (28 גר')", "3/4 כוס מיץ תפוזים טבעי"],
  ...
  },
  {
    ...
    name: "שייק ירוק טרופי",
    level: 2, timeLabel: "דקה", cubes: 2, meal: "ביניים",
    ingredients: ["בננה קפואה", "1/2 כוס קוביות אננס", "1/2 תפוח ירוק חתוך לקוביות", "2 מנות SimpliiGood (28 גר')", "מיץ מחצי לימון", "כפית דבש", "3–4 עלי בזיליקום", "4–5 עלי נענע", "3/4 כוס מי קוקוס (~180 מ\"ל)"],
